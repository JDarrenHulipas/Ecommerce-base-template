...
--
-- Importante: cada bloque activa su tenant con app.set_tenant(),
-- porque con Row Level Security la sesión solo puede escribir
-- en la tienda activa.
-- ============================================================
...
(1, 1, 'cruasan-mantequilla', 'Cruasán de mantequilla', 'Hojaldrado durante 72 horas, 100% mantequilla.', 2.50, 50, TRUE),
(1, 1, 'napolitana-chocolate', 'Napolitana de chocolate', 'Con chocolate belga y masa de mantequilla.',      3.20, 30, TRUE),
(1, 2, 'tarta-frambuesa',      'Tarta de frambuesa',      'Bizcocho de vainilla, crema y frambuesas frescas.', 22.00, 5, TRUE),
(1, 3, 'cafe-espresso',        'Café espresso',           'Tueste natural de origen colombiano.',              1.80, 100, TRUE);
...
INSERT INTO productos (tienda_id, categoria_id, slug, nombre, descripcion, precio, stock, disponible) VALUES
(2, 1, 'mantecado-canelas', 'Mantecados de canela', 'Receta tradicional andaluza, 12 unidades.', 6.50, 20, TRUE),
(2, 2, 'cake-embarazo',     'Cake reveal de género', 'Bizcocho sorpresa con relleno de color.',   35.00, 2, TRUE);
